        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {SERVICES.map(({ icon: Icon, color, title, body, bullets }) => (
              <div key={title} className="bg-white backdrop-blur-md rounded-2xl p-8 ring-1 ring-cyan-200 hover:ring-opacity-60 transition-all hover:bg-gray-50">
            ...
            <div className="bg-white backdrop-blur-md rounded-2xl p-7 border border-cyan-200">
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <input required value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))} placeholder="Your name *" className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 placeholder-gray-400" />
                  <input required type="email" value={form.email} onChange={e => setForm(p => ({ ...p, email: e.target.value }))} placeholder="Your email *" className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 placeholder-gray-400" />
                  <input value={form.phone} onChange={e => setForm(p => ({ ...p, phone: e.target.value }))} placeholder="Your phone" className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 placeholder-gray-400" />
