...
export default function Adopt() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      {/* Filters */}
      <div className="bg-slate-900/40 backdrop-blur-md border-b border-cyan-500/20 shadow-sm sticky top-16 z-30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(9)].map((_, i) => (
              <div key={i} className="bg-slate-800/40 rounded-2xl overflow-hidden animate-pulse backdrop-blur-md">
      ...
      {/* Adoption Info */}
      <div className="bg-slate-900/40 backdrop-blur-md border-t border-cyan-500/20 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-block bg-slate-800/40 backdrop-blur-md rounded-2xl p-5 text-left shadow-sm text-sm text-slate-300 border border-cyan-500/20">
