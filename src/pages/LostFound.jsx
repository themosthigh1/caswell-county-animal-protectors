...
export default function LostFound() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[...Array(8)].map((_, i) => <div key={i} className="bg-gray-200 backdrop-blur-md rounded-2xl h-72 animate-pulse border border-gray-300" />)}
          </div>
        ) : current.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowForm(null)}>
          <div className="bg-white backdrop-blur-md rounded-2xl w-full max-w-xl max-h-[95vh] overflow-y-auto shadow-2xl p-6 sm:p-8 border border-cyan-200" onClick={e => e.stopPropagation()}>
