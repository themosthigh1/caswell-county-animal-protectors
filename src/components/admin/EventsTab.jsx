...
export default function EventsTab() {
  ...
  return (
    <div>
      ...
      {/* Search & Filters */}
      <div className="bg-white backdrop-blur-md rounded-2xl border border-cyan-200 p-4 mb-5 space-y-3">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map(event => (
            <div key={event.id} className="bg-white backdrop-blur-md rounded-xl border border-cyan-200 p-4">
